...
CATEGORY_QUERIES = {
  "get_expanders": "#mastermenu-dropdown > .menulevel-0 > div.mastermenu-bigsub",
  "get_link_containers": "div > div > div",
  "get_inner_links": "div > ul > li > a",
  "get_top_level_link_data_name": "div > a > span::text",
  "get_top_level_link_data_url": "div > a::attr(href)",
